            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: Color(0x33FF8F00), blurRadius: 12, offset: Offset(0, 6)),
                  ],
                ),
                child: Stack(
                  children: [
                    Positioned(
                      right: -20,
                      bottom: -20,
                      child: Icon(Icons.local_offer_rounded, size: 140, color: Colors.white.withValues(alpha: 0.2)),
                    ),
                    const Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '00% OFF',
                            style: TextStyle(fontFamily: 'Inter', fontSize: 36, fontWeight: FontWeight.w800, color: Colors.white),
                          ),
                          SizedBox(height: 4),
                          Text(
                            'Promo Code: NEWCODE',
              ...
              const Text('Offer Details', style: TextStyle(fontFamily: 'Inter', fontSize: 16, fontWeight: FontWeight.w700, color: Colors.black87)),
              const SizedBox(height: 16),

              const Text('Select Service', style: TextStyle(fontFamily: 'Inter', fontSize: 13, fontWeight: FontWeight.w600, color: Colors.black54)),
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    items: _myServices.map<DropdownMenuItem<String>>((String value) {
              ...
              Row(
                children: [
                   Expanded(child: _buildInputField(label: 'Discount (%)', hint: 'e.g., 20', keyboardType: TextInputType.number)),
                   const SizedBox(width: 16),
                   Expanded(child: _buildInputField(label: 'Promo Code', hint: 'e.g., SUMMER20')),
                ],
              ),
              const SizedBox(height: 20),
        ...
        child: SafeArea(
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFFFF8F00), // Action color for offers
